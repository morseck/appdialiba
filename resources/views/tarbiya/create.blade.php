        ...
        <div class="col-md-8 col-12 mr-auto ml-auto">
            ...
            <div class="wizard-container">
                <div class="card card-wizard" data-color="green" id="wizardProfile">
                    <form action="{{ route('tarbiya.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf()
                    <!--        You can switch " data-color="primary" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
                        <div class="card-header text-center">
                            <h4 class="card-title">Ndongo Tarbiya N° {{ nb_tarbiyas() + 1 }}</h4>
                            <h5 class="card-description">Création d'un nouveau Ndongo Tarbiya.</h5>
                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-group form-control-lg">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="commentaire" name="commentaire" rows="3" style="width: 115% !important;">{{ old('commentaire') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
