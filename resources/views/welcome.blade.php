...
<head>
  ...
  <title> AppDialiba | Accueil</title>
...
<body class="offline-doc">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
    <div class="container-fluid"><div class="navbar-wrapper">
  ...
  <div class="page-header clear-filter" filter-color="orange">
    <div class="page-header-image" style="background-image: url('../assets/img/header-doc.jpg');"></div>
    <div class="content-center">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('login') }}">
          ...
          <button type="submit" class="btn btn-social btn-link btn-google">Connexion</button>
        </form>
      </div>
    </div>
      </div>
