                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="input-group form-control-lg">
                              ...
                              <option value="">Niveau</option>
                                  ...
                                  {{--11--}}<option value="LAA YOUHIBOU LAAHOU">LAA YOUHIBOU LAAHOU</option>
                                  {{--12--}}<option value="KHAALA RADJOULAANI">KHAALA RADJOULAANI</option>
                                  {{--13--}}<option value="LA TADJIDANNA">LA TADJIDANNA</option>
                                  {{--14--}}<option value="INNAMAA YASTADJIIBOU">INNAMAA YASTADJIIBOU</option>
                                  {{--15--}}<option value="WALAWAN NANAA">WALAWAN NANAA</option>
                                  {{--16--}}<option value="FAMAA KAANA DA-E-WEEHOUME">FAMAA KAANA DA-E-WEEHOUME</option>
                                  {{--17--}}<option value="KHAALALE MALA-OU">KHAALALE MALA-OU</option>
                                  {{--18--}}<option value="WA IZE NATAGHNAL DJABALA">WA IZE NATAGHNAL DJABALA</option>
                                  ...
                                  {{--21--}}<option value="INNAMA SABILOU">INNAMA SABILOU</option>
                                  {{--22--}}<option value="LILEZIINA AHSANOUL HOUSNE">LILEZIINA AHSANOUL HOUSNE</option>
                                  {{--23--}}<option value="WA MAA MINE DAABATINE">WA MAA MINE DAABATINE</option>
                                  {{--24--}}<option value="WA ILAA MADEYANA">WA ILAA MADEYANA</option>
                                  ...
                                  {{--31--}}<option value="KHAALA ALAMA KHOULE">KHAALA ALAMA KHOULE</option>
                                  {{--32--}}<option value="TAA HEE">TAA HEE</option>
                                  {{--33--}}<option value="IKHTARABA">IKHTARABA</option>
                                  {{--34--}}<option value="YA AYOUHAN-NAASSOU">YA AYOUHAN-NAASSOU</option>
                                  {{--35--}}<option value="KHADF LAKHA">KHADF LAKHA</option>
                                  {{--36--}}<option value="YA AYOUHAL LEUZIINA AAMANOU LAA TAT-TABI-OU - WA KHALAL LEUZIINA">YA AYOUHAL LEUZIINA AAMANOU LAA TAT-TABI-OU - WA KHALAL LEUZIINA</option>
                                  ...
                                  {{--41--}}<option value="WALAA TOUDJAADILOU">WALAA TOUDJAADILOU</option>
                                  ...
                                  {{--53--}}<option value="KHAALA FAMAA KHATBOUKOUMOU">KHAALA FAMAA KHATBOUKOUMOU</option>
                                  {{--54--}}<option value="AR-RAHMANOU">AR-RAHMANOU</option>
                                  ...
                                  {{--61--}}<option value="TOPATE">TOPATE</option>
                                  {{--62--}}<option value="BAA-SIIN">BAA-SIIN</option>
                                </select>
                              </div>
                            </div>
                          </div>
