...
<head>
    ...
    <title>{{ __('messages.welcome') }} {{ $title ?? ''}} {{ config('app.name') }}</title>
                                ...
                                @if(auth()->user()->hasPermission('view-talibes') ||
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="{{ route('talibe.index') }}">
                                            <span class="sidebar-mini"> {{ __('messages.list_short') }} </span>
                                ...
                                @if(auth()->user()->hasPermission('create-talibes') ||
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="{{ route('talibe.create') }}">
                                            <span class="sidebar-mini"> {{ __('messages.new_short') }}</span>
                                            <span class="sidebar-normal"> {{ __('messages.new') }} </span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if(auth()->user()->hasPermission('view-talibes-archives') ||
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="{{ route('talibe.deleted') }}">
                                            <span class="sidebar-mini"> {{ __('messages.archives_short') }}</span>
                                            <span class="sidebar-normal"> {{ __('messages.archives') }} </span>
                                        </a>
                                    </li>
                                @endif
                            </ul>
                  ...
                  auth()->user()->is_admin
                    ...
                    <li class="nav-item  {{ Request::is('tarbiya*') ? 'active' : '' }}">
                        <a class="nav-link" data-toggle="collapse" href="#tarbiya">
                            ...
                            <p> {{ __('messages.ndongo_tarbiya') }}</p>
                        </a>
                                   ...
                                   auth()->user()->is_admin
                                    ...
                                    <li class="nav-item ">
                                        ...
                                        <a class="nav-link"  href="{{ url('transaction-logs?') }}">
                                            <span class="sidebar-mini"> {{ __('messages.logs_transaction_short') }} </span>
                                            <span class="sidebar-normal"> {{ __('messages.logs_transaction') }} </span>
                                        </a>
                                    </li>
                                @endif
                                   ...
                                   auth()->user()->is_admin
                                    ...
                                    <li class="nav-item ">
                                        ...
                                        <a class="nav-link"  href="{{ route('logs.index') }}">
                                            <span class="sidebar-mini"> {{ __('messages.logs_framework_short') }} </span>
                                            <span class="sidebar-normal"> {{ __('messages.logs_framework') }} </span>
                                        </a>
                                    </li>
                                @endif
                ...
                <div class="collapse navbar-collapse justify-content-end">
                    <form class="navbar-form" method="get" action="{{route('reccherche_talibe')}}">
                        <div class="input-group no-border">
                            <input type="text" name="recherche" class="form-control" placeholder="{{ __('messages.search_placeholder') }}">
                        </div>
                    </form>
                    <ul class="navbar-nav" style="padding-right:35px;padding-left: 50px;">
                        <li class="nav-item">
                            <a class="nav-link" href="#" title="{{ __('messages.profile') }}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right text-black-50" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="#">
                                    <span style="color: black">{{ __('messages.my_account') }}</span>
                                </a>

                                <a class="dropdown-item" href="{{ route('logout') }}"
                                   onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                    <span style="color: black">{{ __('messages.logout') }}</span>
                                </a>
                    ...
                    <div class="language-selector">
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="languageDropdown" data-toggle="dropdown">
                                {{ current_locale() === 'ar' ? __('messages.arabic') : __('messages.french') }}
                            </button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="">
                        ...
                        <div class="card-body">
                            <button class="btn" onclick="history.back()" data-toggle="tooltip"  data-placement="left" title="{{ __('messages.back_tooltip') }}">
                              <span class="btn-label">
                                <i class="material-icons">keyboard_arrow_left</i>
                              </span>
                                {{ __('messages.previous') }}
                            </button>
                            <button class="btn btn-success" onclick="history.forward()"  data-toggle="tooltip"  data-placement="left" title="{{ __('messages.forward_tooltip') }}">
                                {{ __('messages.next') }}
                                <span class="btn-label">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright float-center">
                    ...
                    </script>, {{ __('messages.developed_with') }} <i class="material-icons">favorite</i> {{ __('messages.by') }}
                    <a href="#" >{{ __('messages.khidmatech_group') }}</a> {{ __('messages.for') }} {{ __('messages.serigne_hamsatou') }}
                </div>
            </div>
        </footer>
    </div>
