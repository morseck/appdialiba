@extends('layouts.scratch',['title' => 'Nouveau daara |'])
              ...
              <div class="row">
                <div class="col-lg-6 card" style="margin: auto;">
                  ...
                  <div class="card-header text-center">
                      <h3 class="card-title" style="margin-top: 20px;">AJOUT NOUVEAU DAARA</h3>
                      <h5 class="card-description">N° {{ nb_daaras() + 1 }}</h5>
                  </div>
                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="form-group has-default">
                              <input type="text" class="form-control" name="dieuw" value="{{ old('dieuw') }}" required>
                            </div>
                          </div>
                        </div><br>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="form-group has-default">
                              <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" minlength="9" required>
                            </div>
                          </div>
                        </div><br>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-8">    
                                <input type="text" name="creation" id="creation" class="form-control" placeholder="La date de création du Daara" style="background-color: transparent;">
                            </div>
                        </div><br>
                  ...
                  <dir class="card-footer">
                    <div class="container">
                        ...
                        <div class="col-lg-6 text-center"  style="margin: auto;margin-top: 3px;">
                              <button type="submit" class="btn btn-success" >Nouveau Daara</button>
                       </div>
                        </div>
                    </div>
                  </dir>
